...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(NuGet.Server.Core.Tests.App_Start.NuGetODataConfig), "Start")]

namespace NuGet.Server.Core.Tests.App_Start 
{
